...
def make_channel_nfos_url(api_key, channel_name):
	return "https://youtube.googleapis.com/youtube/v3/channels?part=contentDetails&forUsername=%s&key=%s" % (channel_name, api_key)
...
channel_req_url = make_channel_nfos_url(api_key, channel_name)
...
if args.file:
	out_name = sanitize_filename(channel_name) + ".log"
